  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        response = await authAPI.register({ name, email, password, age: 28, bio: '' });
      }
  ...
  return (
    <ScrollView className="flex-1 bg-[#F8F5F2] px-6 pt-20">
      ...
      <View className="bg-white rounded-3xl p-8 shadow-sm">
        ...
        {!isLogin && (
          <TextInput
            className="bg-gray-100 rounded-2xl px-5 py-4 mb-4"
        ...
        <TextInput
          className="bg-gray-100 rounded-2xl px-5 py-4 mb-8"
