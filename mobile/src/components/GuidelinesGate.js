...
export default function GuidelinesGate({ children }) {
  ...
  if (accepted === null) {
    return (
      <View style={{ flex: 1, backgroundColor: '#F8F5F2', justifyContent: 'center', alignItems: 'center' }}>
  ...
  if (!accepted) {
    return (
      <View style={{ flex: 1, backgroundColor: '#F8F5F2', padding: 24, justifyContent: 'center' }}>
        <Text style={{ fontSize: 28, fontWeight: '300', marginBottom: 16 }}>Community Guidelines</Text>
        ...
        <Text style={{ fontSize: 15, color: '#555', lineHeight: 22, marginBottom: 8 }}>
        ...
        <Text
          style={{ fontSize: 14, color: '#4A7043', textDecorationLine: 'underline', marginBottom: 28 }}
        ...
        <Pressable
          onPress={accept}
          style={{ backgroundColor: '#4A7043', padding: 18, borderRadius: 999, alignItems: 'center' }}
        >
          <Text style={{ color: 'white', fontWeight: '600', fontSize: 16 }}>I Agree & Continue</Text>
        </Pressable>
      </View>
    );
  }
